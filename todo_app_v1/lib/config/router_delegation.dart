...
class RouterDelegation extends RouterDelegate<RouteConfiguration>
  ...
  final _impl = TodoRepositoryImpl();
        ...
        pages: [
          MaterialPage(
              ...
              child: TodoListScreen(
                getTodosUseCase: GetTodosUseCase(_impl),
                removeTodoUseCase: RemoveTodoUseCase(_impl),
                markTodoAsCompletedUseCase: MarkTodoAsCompletedUseCase(_impl),
                onRemoveTodo: (id) {
                  _configuration = RouteConfiguration.home();
                  notifyListeners();
                },
          ...
          if (_configuration.route == Routes.add)
            MaterialPage(
              ...
              child: TodoAddScreen(
                addTodoUseCase: AddTodoUseCase(_impl),
                onAddTodo: () {
                  _configuration = RouteConfiguration.home();
                  notifyListeners();
                },
